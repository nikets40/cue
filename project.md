...
- ⬜ Next in **Phase 2** — package Booth as a real .app (vendor mediaremote-adapter, fix launch-at-login path), VLC playlist/seeking, then extension-driven playlist browsing + like/dislike.
