...
- ⬜ Next: **Phase 2** — Live Activity / Dynamic Island (designs in `design/app-design.html`), Chrome extension (also unlocks tier-3 artwork + reliable service detection without AppleScript), VLC niceties, vendor mediaremote-adapter + bundle Booth as a real .app.
