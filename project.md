...
- ⬜ Remaining phase-2 ideas: extension-driven playlist browsing + like/dislike for YouTube Music (the extension bridge is in place, so this is DOM scripting plus new commands).
